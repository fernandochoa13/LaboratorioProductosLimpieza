...
$ProductosMasStock = array("","","","","");
$MayorStock = array(0,0,0,0,0);
//Mas vendidos
$longitud = count($stock);
    ...
    for($i = 0;$i < 5;$i++){
            $MayorStock[$i] = $stock[$i];
            $ProductosMasStock[$i] = $nombreProducto[$i];
    }
    ?>
<!DOCTYPE html>
<html lang="en">
...
<nav>
    ...
    <h1 class="titulo-Seccion">Los 5 productos más producidos</h1> <br><br>
    </div>
    <div class="container">
    ...
    <script>
        ...
        let lineChart = new Chart(CHART, {
            type: "line",
            data: {
                labels: [<?php echo '"'.implode('","',  $ProductosMasStock ).'"' ?>],
                datasets: [{
                    label: 'Producción',
                    data: [<?php echo '"'.implode('","',  $MayorStock ).'"' ?>],
                    fill: false,
