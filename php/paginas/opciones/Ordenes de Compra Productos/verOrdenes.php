...
<head>
    ...
    <title>Ver Ordenes de Productos</title>
...
<table class="table">
        ...
        <tr>
            ...
            <?php if($rows['estatus'] == 0) { ?>
                <td><a href="procesarOrden.php?id=<?php echo $rows['idorden']?>"><input type="submit" name="btn-Procesar" class="btn btn-dark" value="Procesar"></a></td>
            <td><a href="borrarOrdenCompraProducto.php?id=<?php echo $rows['idorden']?>" style="color: rgb(83, 184, 180)"><ion-icon name="trash-outline"></ion-icon></a></td>
          <?php  }  ?>
          <td><a href="../fpdf/ReportesOrdenCompraProducto.php?id=<?php echo $rows['idorden']?>" target="_blank">Reporte PDF</a></td>
...
if(isset($_POST['nuevoRegistro'])) {
    header("Location:nombreOrdenProducto.php");
}
