...
<nav>
    ...
    <input type="submit" name="nombreOrden" class="btn">
    </form>
</div>
</section>
<footer>
...
if(isset($_POST['nombreOrden']) && !empty('botonProducto')) {
    ...
    $queryResult = mysqli_query($conn, "INSERT INTO orden (nombreorden, tipoOrden) VALUES ('$nombreOrden', 0)");
    ...
    header("Location:crearOrdenCompraInsumo.php?id=".$row[0]);
}
ob_end_flush();
?>
